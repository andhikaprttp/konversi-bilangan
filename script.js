...
function convertBinary() {
  ...
  // Konversi ke heksadesimal
  document.getElementById("hexadesimal").value = parseInt(biner, 2).toString(
    16
  );
}
...
function convertOctal() {
  ...
  // Konversi ke heksadesimal
  document.getElementById("hexadesimal").value = parseInt(oktal, 8).toString(
    16
  );
}
...
function convertHexadecimal() {
  ...
  // Konversi ke biner
  document.getElementById("biner").value = parseInt(hexadesimal, 16).toString(
    2
  );

  // Konversi ke oktal
  document.getElementById("oktal").value = parseInt(hexadesimal, 16).toString(
    8
  );
}
